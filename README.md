...
![Convolutional Recurrent Neural Network with Diarization Filter](https://github.com/adino99/Music-Artist-Classification-with-Diarization-Filter/blob/main/images/diarization.png?raw=true)
